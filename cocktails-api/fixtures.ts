...
const run = async () => {
  ...
  await Cocktail.create(
      {   title: "Margarita",
          ...
          isPublished: true,
          user: user1._id,
          recipe: "1. В шейкер положите лед, лимонный сок, текилу и апельсиновый ликер. 2. Встряхните хорошо. 3. Процедите в бокал, наполненный льдом. 4. Украсьте куском лимона или солью по краю бокала.",
          ingredients: [
      ...
      },
      {
          ...
          isPublished: false,
          user: user1._id,
          recipe: "1. В стакан положите кубик сахара, ангостуру биттер и немного воды. 2. Размешайте до растворения сахара. 3. Добавьте кубики льда и виски. 4. Перемешайте и украсьте цедрой апельсина и вишней.",
          ingredients: [
      ...
      },
      {
          ...
          isPublished: true,
          user: user2._id,
          recipe: "1. В блендер положите ананасовый сок, кокосовое молоко, ром и лед. 2. Взбейте до получения однородной массы. 3. Вылейте в бокал и украсьте куском ананаса и вишней.",
          ingredients: [
      ...
      },
      {
          ...
          isPublished: true,
          user: user1._id,
          recipe: "1. В стакан с льдом налейте джин, вермут и красный биттер. 2. Перемешайте. 3. Украсьте кружком апельсина.",
          ingredients: [
